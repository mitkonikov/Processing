public class WINDOW {
   ...
   ArrayList<WINCHILD> childrens = new ArrayList<WINCHILD>();
   ...
   // FUNCTION FOR ADDING CHILDREN INSIDE THE WINDOW
   void addChildren(int x, int y, int w, int h, int r, int g, int b) {
      WINCHILD newChildren = new WINCHILD(x, y, w, h);
      newChildren.SETCOLOR(r, g, b);
